...
Всё в одном файле (471 MB — образы + конфиги внутри):

**https://drive.google.com/file/d/1iQkfALBUvMzk2r_VCfz6DvFI49AVn15H/view**
...
| `democracy-api` | `…/democracy-service:1.0.31` | API + WebSocket, профиль `standalone` |
