...
|---|---|---|
| democracy-api | `2345…/democracy-service:1.0.31` | `CampAndGame/CampDemocracyService` (профиль `standalone`) |
| democracy-player | `2345…/democracy-player:1.0.15` | `DemocracyReact` (= `JS/Democracy`) — тот же образ, что онлайн |
